...
function Shell({ title, icon, onClose, children, isDark, isMobile, drawerOpen, onDrawerClose }: ShellProps) {
...
export function LeftPanel({ handle, onResetView, onClose, isDark, isMobile, drawerOpen, onDrawerClose }: Props) {
